                  ...
                  <div className="col-md-6 offset-md-3 border rounded p-4 mt-4 shadow dark ">
                      ...
                      <form onSubmit={handleSubmit} >
                          ...
                          {/* <button type='submit' className='btn btn-info'>Submit</button> */}
                           ...
                           <button type="submit" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-sm" >Login</button>

                           <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                           <div class="modal-dialog modal-sm">
                           <div class="modal-content">form submitted Successfully !!
                           </div>
                           </div>
                           </div></form></div>
              </div>
