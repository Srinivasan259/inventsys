    ...
    <>
      ...
      >
        <div className="container-fluid">
          ...
          <div
            className="collapse navbar-collapse mx "
          ...
          >
            ...
            <Link
              ...
              id="tbn"
            >
              <b>Delete Record by Id</b>
            </Link>
            <Link className="btn btn-outline-light mx" to="/Register" id="tbn">
              <b>Sign Up</b>
            </Link>
            <Link className="btn btn-outline-light mx" to="/" id="tbn">
              <b>Log Out</b>
            </Link>
          </div>
        </div>
      ...
      <div className="container ">
        ...
        <div className="py-4">
          <table
            className="table border shadow table table-success table-striped "
            id="main"
          >
                  ...
                  <tr>
                    ...
                    <td>
                      <Link
                        ...
                        to={`/Viewinvent/${invent.itemId}`}
                      >
                        View
                      </Link>
                      <Link
                        className="btn btn-warning mx-1"
                        to={`/Editinvent/${invent.itemId}`}
                      >
                        Edit
                      </Link>
                      <button
                        className="btn btn-danger mx-1"
                        onClick={() => deleteInvent(invent.itemId)}
                      >
                        Delete
                      </button>
                    </td>
